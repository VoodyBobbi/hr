...
- повтор одного и того же сообщения подряд и быстрее чем через
  FAST_REPLY_SECONDS: +2 балла (REPEAT_MESSAGE_POINTS)
- просто слишком частые сообщения: +1 балл (HIGH_FREQUENCY_POINTS)
