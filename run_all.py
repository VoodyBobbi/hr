...
def main():
    ...
    server_process = subprocess.Popen([
        ...
        "--proxy-headers",
        # Кому доверять заголовок с адресом. "*" означает «любому источнику»
        # и годится, пока сервер доступен только через свой прокси. Если
        # порт 8000 будет открыт наружу напрямую, замените на адрес прокси —
        # иначе посетитель сможет подделать свой адрес и обойти блокировку.
        "--forwarded-allow-ips", "*",
    ])
